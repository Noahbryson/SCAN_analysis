...
xlabel(tcl, 'Time (s)');
%%
figpath="/Users/nkb/Library/CloudStorage/Box-Box/Brunner Lab/Writing/manuscripts/SCAN ABLATION 2025/figures/FIG1";

% exportgraphics(fig,fullfile(figpath,'SZ_ephys.svg'))
% print(fig,fullfile(figpath,'SZ_ephys.svg'),'-dsvg')

exportgraphics(gcf,fullfile(figpath,'SZ_ephys_200Hz.pdf'),'ContentType','vector')
